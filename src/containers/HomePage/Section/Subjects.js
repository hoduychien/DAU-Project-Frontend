                    ...
                    <div className="subjects-item">
                      <div onClick={() => this.handleDetailSubject(item)}>
                        <img
                          src={imgBase64}
                          alt=""
                          className="subjects-item-banner"
                        />
                      </div>
                      <div className="subjects-item-info">
                        ...
                        <span className="subjects-item-title">{item.name}</span>
                        <p className="subjects-item-desc">{item.desc}</p>
                        <p className="subjects-item-descs">{item.location}</p>
                        <div
                          className="subjects-item-more"
                          onClick={() => this.handleDetailSubject(item)}
                        >
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(Subjects)
);
