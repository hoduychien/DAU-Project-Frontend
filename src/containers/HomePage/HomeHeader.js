...
class HomeHeader extends Component {
  ...
  handleOpenUserProfile = () => {
    ...
    this.props.history.push(`/user-profile/${user.id}`);
    window.scrollTo(0, 0);
  };
        ...
        <div className="home-header">
          <div className="home-header-main">
            <div className="home-header-logo">
              <span onClick={() => this.handleBackHome()}>CyberLearn</span>
            </div>
            ...
            <div
              className={
                isLoggedIn === true ? "header-auth d-none" : "header-auth"
              }
            >
            ...
            <div
              className={
                isLoggedIn === false ? "nav-profile d-none" : "nav-profile"
              }
            >
              ...
              <div className="nav-profile-detail">
                ...
                <div
                  className="nav-profile-detail-item"
                ...
                <div
                  className={
                    userInfo && userInfo.roleId === "R3"
                      ? "nav-profile-detail-item d-none"
                      : "nav-profile-detail-item "
                  }
                >
                  <MdDashboard />
                  <a href="/system/user-manage-redux" target="_blank">
                    Dashboard
                  </a>
                </div>
                <div
          ...
          <div className="home-hero">
            <div className="home-hero-content">
              ...
              <div className="home-hero-desc">
                ...
                elementum tortor facilisi tristique viverra ullamcorper odio mi
                tincidunt.
              </div>
