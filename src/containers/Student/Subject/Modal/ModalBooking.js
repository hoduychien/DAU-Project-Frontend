...
class ModalBooking extends Component {
  ...
  async componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (
      this.props.dataScheduleChoose.subjectId !==
      prevProps.dataScheduleChoose.subjectId
    ) {
      let data = await this.getSubjectInfo(
        this.props.dataScheduleChoose.subjectId
      );
      let subjectId = this.props.dataScheduleChoose.subjectId;
      let timeType = this.props.dataScheduleChoose.timeType;
  ...
  handleConfirm = async () => {
    ...
    if (dataFromParent && dataFromParent.Subject_info) {
      ...
      lecturersId = dataFromParent.Subject_info.lecturersId;
    }
    ...
    if (dataTime && !_.isEmpty(dataTime)) {
      let time =
        language === languages.VI
          ? dataTime.timeTypeData.vi
          : dataTime.timeTypeData.en;

      let date = moment(new Date(parseInt(dataTime.date))).format(
        "ddd - DD/MM/YYYY"
      );
      return `${time} - ${date}`;
    }
  ...
  render() {
    ...
    let date = moment(new Date(parseInt(dataScheduleChoose.date))).format(
      "DD-MM-YYYY"
    );
          ...
          <ModalBody>
            ...
            <div className="modal-booking">
              <div className="modal-booking-info">
                ...
                <div className="modal-booking-text">
                  <div className="modal-booking-text-left">Time study:</div>
                ...
                <div className="modal-booking-text">
                  <div className="modal-booking-text-left">Hotline :</div>
                ...
                <div className="modal-booking-text">
                  <div className="modal-booking-text-left">Thơi gian học :</div>
                  <div className="modal-booking-text-right">
                    {dataScheduleChoose &&
                    dataScheduleChoose.timeTypeData &&
                    language === languages.VI
                ...
                <div className="modal-booking-text">
                  <div className="modal-booking-text-left">Email :</div>
                  <div className="modal-booking-text-right blue-span">
                    chienhoo20@gmail.com
                  </div>
                </div>
                <div className="modal-booking-text">
                  <div className="modal-booking-text-left">Tuition :</div>
                  <div className="modal-booking-text-right">{currency}</div>
                </div>
                <div className="modal-booking-text">
                  <div className="modal-booking-text-left">Payment :</div>
                  <div className="modal-booking-text-right">
                    {dataFromParent &&
                    dataFromParent.Subject_info &&
                    language === languages.VI
              ...
              <div className="modal-booking-form">
                <div className="modal-booking-form-main">
                  <div className="modal-booking-input">
                    <div className="modal-booking-input-label">Họ tên :</div>
                    <input
                      type="text"
                      placeholder="Họ và tên ..."
                      value={this.state.fullName}
                      onChange={(event) =>
                        this.handleOnchangeIput(event, "fullName")
                      }
                    />
                  ...
                  <div className="modal-booking-input">
                    ...
                    <input
                      ...
                      onChange={(event) =>
                        this.handleOnchangeIput(event, "phone")
                      }
                    />
                    <BiPhone className="icons" />
                  </div>
                  <div className="modal-booking-input">
                    <div className="modal-booking-input-label">Email :</div>
                    <input
                      type="email"
                      placeholder="Địa chỉ email ..."
                      value={this.state.email}
                      onChange={(event) =>
                        this.handleOnchangeIput(event, "email")
                      }
                    />
                    <BiMailSend className="icons" />
                  </div>
                  <div className="modal-booking-input">
                    <div className="modal-booking-input-label">Địa chỉ :</div>
                    <input
                      type="text"
                      placeholder="Địa chỉ ..."
                      value={this.state.address}
                      onChange={(event) =>
                        this.handleOnchangeIput(event, "address")
                      }
                    />
                  ...
                  <div className="modal-booking-input">
                    <div className="modal-booking-input-label">Ngày sinh :</div>
                    <DatePicker
                  ...
                  <div className="modal-booking-actions ">
                    <div
                      className="modal-booking-button modal-booking-button-accept"
