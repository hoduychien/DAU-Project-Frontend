...
export const getSubjectRequired = () => {
  return async (dispatch, getState) => {
    try {
      ...
      let resLecrurers = await getLecturers(10);
      ...
      if (
        ...
        resStudyTime &&
        resStudyTime.errorCode === 0 &&
        resCourses &&
        resCourses.errorCode === 0 &&
        resLecrurers &&
        resLecrurers.errorCode === 0
      ) {
        let data = {
          ...
          resLecrurers: resLecrurers.data,
        };
        console.log(data);
